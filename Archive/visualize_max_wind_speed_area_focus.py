...
# =====================================================================
# # LOAD AND PLOT DURHAM COUNTY BOUNDARY
# =====================================================================
try:
    print("Loading Durham County GeoJSON...")
    durham_boundary = gpd.read_file('geo/DCo_Boundary.geojson')
    
    # Ensure the GeoJSON is in standard lat/lon (WGS84) to match your grid
    if durham_boundary.crs != "EPSG:4326":
        durham_boundary = durham_boundary.to_crs(epsg=4326)
        
    # Plot the boundary line on axes[0]
    durham_boundary.plot(ax=axes[0], facecolor='none', edgecolor='cyan', linewidth=2, label='Durham Co. Boundary')
    print("✓ Successfully overlayed Durham County boundary!")
